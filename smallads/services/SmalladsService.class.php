...
class SmalladsService
{
	...
	public static function get_smallad($condition, array $parameters = array())
	{
	...
	public static function update_number_view(Smallad $smallad)
	{
		self::$db_querier->update(SmalladsSetup::$smallads_table, array('number_view' => $smallad->get_number_view()), 'WHERE id=:id', array('id' => $smallad->get_id()));
	}
