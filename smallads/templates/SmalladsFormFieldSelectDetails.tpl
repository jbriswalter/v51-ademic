...
SmalladsFormFieldSelectDetails.prototype = {
	add_field : function () {
		if (this.integer <= this.max_input) {
			...
			jQuery('<a/> ', {href : 'javascript:SmalladsFormFieldSelectDetails.delete_field('+ this.integer +');'}).html('<i class="fa fa-delete"></i>').appendTo('#' + id);
...
var SmalladsFormFieldSelectDetails = new SmalladsFormFieldSelectDetails();
-->
</script>
...
# START fieldelements #
	<div id="${escape(ID)}_{fieldelements.ID}">
		...
		<a href="javascript:SmalladsFormFieldSelectDetails.delete_field({fieldelements.ID});" data-confirmation="delete-element"><i class="fa fa-delete"></i></a>
	</div>
# END fieldelements #
</div>
<a href="javascript:SmalladsFormFieldSelectDetails.add_field();" id="add-${escape(ID)}"><i class="fa fa-plus"></i></a> 