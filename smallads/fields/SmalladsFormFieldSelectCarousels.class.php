<?php
/*##################################################
 *		      SmalladsFormFieldSelectCarousels.class.php
 *                            -------------------
 *   begin                : June 23, 2016
...
class SmalladsFormFieldSelectCarousels extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('smallads/SmalladsFormFieldSelectCarousels.tpl');
