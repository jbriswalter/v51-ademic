<?php
/*##################################################
 *		      SmalladsFormFieldSelectColors.class.php
 *                            -------------------
 *   begin                : June 23, 2016
...
class SmalladsFormFieldSelectColors extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('smallads/SmalladsFormFieldSelectColors.tpl');
