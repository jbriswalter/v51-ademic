<?php
/*##################################################
 *		      SmalladsFormFieldSelectDetails.class.php
 *                            -------------------
 *   begin                : June 23, 2016
...
class SmalladsFormFieldSelectDetails extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('smallads/SmalladsFormFieldSelectDetails.tpl');
