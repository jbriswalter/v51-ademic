<?php
/*##################################################
 *		                  SmalladsDeleteController.class.php
 *                            -------------------
 *   begin                : June 23, 2016
...
class SmalladsDeleteController extends ModuleController
{
	public function execute(HTTPRequestCustom $request)
	{
		...
		AppContext::get_response()->redirect(($request->get_url_referrer() ? $request->get_url_referrer() : SmalladsUrlBuilder::home()), StringVars::replace_vars(LangLoader::get_message('smallads.message.success.delete', 'common', 'smallads'), array('name' => $smallad->get_name())));
	}
	...
	private function get_smallad(HTTPRequestCustom $request)
	{
		...
		{
			try {
				return SmalladsService::get_smallad('WHERE id=:id', array('id' => $id));
