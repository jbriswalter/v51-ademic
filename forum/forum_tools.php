...
if (!$is_guest) {
    ...
    //Si on est sur un topic, on le supprime dans la requ�te => si ce topic n'�tait pas lu il ne sera plus dans la liste car d�sormais lu.
    $clause_topic = '';
    ...
    //Requ�te pour compter le nombre de messages non lus.
    try {
