...
<li ';if ($_data->is_true($_data->get('C_HAS_SUB_LINK'))){$_result.=' class="has-sub"';}$_result.='>
	<a href="' . $_data->get('U_LINK') . '" class="cssmenu-title" title="' . $_data->get('NAME') . '"><img src="' . $_data->get('IMG') . '" alt="' . $_data->get('NAME') . '"/> ' . $_data->get('NAME') . '</a>
