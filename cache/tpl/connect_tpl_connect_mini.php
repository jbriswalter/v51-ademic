	...
	<div id="connect-menu">
		<div class="horizontal-fieldset">
			...
			<ul class="connect-content">
				...
				<li>
					<i class="fa fa-wrench';if ($_data->is_true($_data->get('C_UNREAD_ALERT'))){$_result.=' blink';}$_result.='"></i>
					<a href="' . $_functions->relative_url(UserUrlBuilder::administration()) . '" class="small"> ' . $_data->get('L_ADMIN_PANEL') . '';if ($_data->is_true($_data->get('C_UNREAD_ALERT'))){$_result.=' (' . $_data->get('NUMBER_UNREAD_ALERTS') . ')';}$_result.='</a>
				</li>
				';}$_result.='
				';if ($_data->is_true($_data->get('C_MODERATOR_AUTH'))){$_result.='
				<li>
				...
				<li>
					<i class="fa fa-file-text';if ($_data->is_true($_data->get('C_UNREAD_CONTRIBUTION'))){$_result.=' blink';}$_result.='"></i>
					<a href="' . $_functions->relative_url(UserUrlBuilder::contribution_panel()) . '" class="small"> ' . $_data->get('L_CONTRIBUTION_PANEL') . '';if ($_data->is_true($_data->get('C_KNOWN_NUMBER_OF_UNREAD_CONTRIBUTION'))){$_result.=' (' . $_data->get('NUMBER_UNREAD_CONTRIBUTIONS') . ')';}$_result.='</a>
				</li>
				<li>
					<i class="fa fa-sign-out"></i>
					<a href="' . $_functions->relative_url(UserUrlBuilder::disconnect()) . '" class="small"> ' . $_data->get('L_DISCONNECT') . '</a>
