							...
							<ul>
								...
								<li class="sub">
									';if ($_data->is_true($_data->get_from_list('U_FOLDER', $_tmp_list))){$_result.='
										<a class="parent" href="javascript:show_pages_cat_contents(' . $_data->get_from_list('ID', $_tmp_list) . ', 0);"><i class="fa fa-plus-square-o" id="img2_' . $_data->get_from_list('ID', $_tmp_list) . '"></i><i id ="img_' . $_data->get_from_list('ID', $_tmp_list) . '" class="fa fa-folder" ></i></a>
			...
			<div class="files">
				...
				<div class="content" id="cat_contents">
					<ul>
						...
						<li>
							<a class="explorer-list-cat-link" href="javascript:open_cat(' . $_data->get_from_list('KEY', $_tmp_list_cats) . '); show_pages_cat_contents(' . $_data->get_from_list('ID_PARENT', $_tmp_list_cats) . ', 0);"><i class="fa fa-folder"></i>' . $_data->get_from_list('TITLE', $_tmp_list_cats) . '</a>
						</li>
						';}$_result.='
