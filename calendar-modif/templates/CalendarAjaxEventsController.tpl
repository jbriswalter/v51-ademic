            ...
            <div itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
                ...
                <div>
                    ...
                    <span>
                        ...
                        <!--****************** ajouts ******************-->
                        <a href="{PATH_TO_ROOT}/calendar/event_participants_list/" class="basic-button">{@calendar.labels.participants_list}</a>
                        <!--<a href="#openmodal-calendar-list-suscribe" class="basic-button">{@calendar.labels.participants_list}</a>-->
                        <div id="openmodal-calendar-list-suscribe" class="openmodal-calendar-list-suscribe">
                            <a href="#closemodal-calendar-list-suscribe" title="${LangLoader::get_message('close_menu', 'admin')}" class="close-calendar-list-suscribe"><span>Fermer</span></a>
                            <div class="list-suscribe-form">
                                <ul>
                                    # START event.participant #
                                    <li>
                                        <a href="{event.participant.U_PROFILE}">{event.participant.DISPLAY_NAME}</a># IF NOT event.participant.C_LAST_PARTICIPANT #<br /># ENDIF #
                                    </li>
