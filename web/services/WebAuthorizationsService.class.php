<?php
/*##################################################
 *                               WebAuthorizationsService.class.php
 *                            -------------------
...
class WebAuthorizationsService
{
	public $id_category;
	...
	{
		$auth = WebService::get_categories_manager()->get_heritated_authorizations($this->id_category, $bit, $mode);
