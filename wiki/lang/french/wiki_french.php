...
$LANG['wiki_empty_index'] = 'Le wiki est vide. Si vous êtes administrateur vous pouvez créer et modifier l\'accueil du wiki dans le panneau d\'administration du wiki.';
$LANG['wiki_previewing'] = 'Prévisualisation';
$LANG['wiki_table_of_contents'] = 'Table des matières';
$LANG['wiki_read_feed'] = 'Lire l\'article';

//Actions
$LANG['wiki_random_page'] = 'Page aléatoire';
...
$LANG['wiki_create_article'] = 'Créer un article';
$LANG['wiki_add_article'] = 'Ajouter un article';
$LANG['wiki_add_cat'] = 'Ajouter une catégorie';
...
$LANG['wiki_edit_cat'] = 'Edition de la catégorie <em>%s</em>';
$LANG['wiki_move'] = 'Déplacer';
$LANG['wiki_rename'] = 'Renommer';
$LANG['wiki_no_cat'] = 'Aucune catégorie existante';
$LANG['wiki_no_sub_cat'] = 'Aucune sous catégorie existante';
$LANG['wiki_no_article'] = 'Aucun article existant';
$LANG['wiki_no_sub_article'] = 'Aucun sous article existant';
$LANG['wiki_no_selected_cat'] = 'Aucune catégorie sélectionnée';
$LANG['wiki_do_not_select_any_cat'] = 'Aucune catégorie';
...
$LANG['wiki_edition_restriction'] = 'Restriction à l\'édition';
